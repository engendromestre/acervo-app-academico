...
<template>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <template v-for="obj, idx in items.data" :key="items.data.id">
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        <template v-for="property, field in fields" :key="field">
                            <td v-if="property.read" :data-label="field" :class="idx % 2 === 0 ? 'bg-white border-b dark:bg-gray-900 dark:border-gray-700' : 'border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700'"
                        ...
                        <td :class="idx % 2 === 0 ? 'bg-white border-b dark:bg-gray-900 dark:border-gray-700' : 'border-b bg-gray-50 dark:bg-gray-800 dark:border-gray-700'"
                            class="px-6 py-4 text-right" v-if="can.edit || can.delete">
